  ...
  test(
    ...
    async ({ page }, testInfo) => {
      ...
      try {
        ...
        // Wait for setActions to land before locking — mirrors the
        // staging pattern at resolve-attack-vs-attack.spec.mjs L360-372.
        // `combat.lockActions` requires all three slots populated
        // (combat.mjs L534 `#applyLockActions`), and setActions itself
        // posts the updates asynchronously.
        await expect
