# Torchbearer 2nd Edition for Foundry VTT
...
- [Burning Wheel HQ](https://www.burningwheel.com/collections/torchbearer)
- [Drive Thru RPQ](https://www.drivethrurpg.com/en/product/448193/torchbearer-2e-core-set-pdf-bundle?src=hottest_filtered)

At the very least, you will need a Scholar's Guide and a Dungeoneer's Handbook. A copy of the Lore Master's Manual is encouraged.
...
Are all AI Generated. If you think one should be replaced, file an issue, and we'll roll the dice again.
...
The code is under the [MIT License](./LICENSE). There are many [icons that come from the incredible game-icons.net](https://game-icons.net) - they are under the [CC BY 3.0](https://creativecommons.org/licenses/by/3.0/) license, as stated in the icons directory license.txt file. The tokens in the assets/tokens directory are all AI generated, and in the public domain. The same is true for the campsite, prologue, town and adventure phase backgrounds.

The Torchbearer wheel symbol is from the Dungeoneer's Handbook, as is the Torchbearer logo. Both can be removed at BWHQ's request.
